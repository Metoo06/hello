...
Page({
  ...
  bindMinus: function (e) {
    ...
    wx.request({
      url: 'http://localhost/xxx/index.php/Api/Shopping/up_cart',
      method: 'post',
      data: {
        user_id: 1,
        num: num,
  ...
  bindCheckout: function () {
    ...
    //存回data
    wx.navigateTo({
      url: '../to-pay-order/to-pay-order?cartId=' + toastStr,
    })
  },
    ...
    wx.showModal({
      ...
      success: function (res) {
        res.confirm && wx.request({
          url: 'http://localhost/xxx/index.php/Api/Shopping/delete',
          method: 'post',
          data: {
            cart_id: cardId,
          },
  ...
  loadProductData: function () {
    var that = this;
    wx.request({
      url: 'http://localhost/xxx/index.php/Api/Shopping/index',
      method: 'post',
      data: {
        user_id: 1
      },
